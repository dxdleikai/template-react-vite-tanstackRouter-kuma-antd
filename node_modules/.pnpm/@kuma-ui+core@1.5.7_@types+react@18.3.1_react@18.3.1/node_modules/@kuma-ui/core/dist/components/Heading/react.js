...
const Heading = (0, import_forwardRef.forwardRef)(
  ({ as: Component = import_handler.defaultHeadingTag, children, ...props }, ref) => {
    const variant = props.variant ? (
      // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-explicit-any -- FIXME
      import_sheet.theme.getVariants("Heading")?.variants?.[props.variant]
    ) : {};
